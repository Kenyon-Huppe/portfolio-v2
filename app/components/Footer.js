  ...
  return (
    <footer className={`${styles.container} ${styles.footer}`}>
      <ul className={styles.socials}>
        <li id='linkedin'>
          <a href="https://www.linkedin.com/in/kenyon-huppe-18178021b/" target='_blank'>
        ...
        <li id='github'>
          <a href="https://github.com/Kenyon-Huppe" target='_blank'>
        ...
        <li id='instagram'>
          <a href="https://www.instagram.com/kenyonhuppe/" target='_blank'>
