        ...
        <div className={styles.contentContainer}>
          ...
          <form action="https://formsubmit.co/2b281571dde7d11a5aa8a253618bde67" method="POST" id="contact-form">
              <div className={`${styles.inputContainer} ${styles.contactName}`}>
                <h4>
                  <label htmlFor="name" className={styles.inputLabel}>Name<span className={styles.requiredInput}>*</span></label>
                </h4>
              ...
              <div className={`${styles.inputContainer} ${styles.contactEmail}`}>
                <h4>
                  <label htmlFor="email" className={styles.inputLabel}>Email<span className={styles.requiredInput}>*</span></label>
                </h4>
              ...
              <div className={`${styles.inputContainer} ${styles.contactSubject}`}>
                <h4>
                  <label htmlFor="subject" className={styles.inputLabel}>Subject<span className={styles.requiredInput}>*</span></label>
                </h4>
              ...
              <div className={`${styles.inputContainer} ${styles.contactMessage}`}>
                <h4>
                  <label htmlFor="message" className={styles.inputLabel}>Message<span className={styles.requiredInput}>*</span></label>
                </h4>
