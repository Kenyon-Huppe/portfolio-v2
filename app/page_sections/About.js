          ...
          <div className={styles.aboutContentContainer}>
            <section className={styles.top}>
              ...
              <div className={styles.imageContainer}>
                <Card imgName={'pfp_optimized.jpg'} classCaller={'profilePic'} />
              </div>
            </section>
